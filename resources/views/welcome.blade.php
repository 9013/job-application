...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('main') }}" title="Admin Login" >Login</a>
            </li>            
        </ul>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div style="padding-top:30px" class="panel-body" >                        
                                ...
                                @endif
                            <form name="my-form" action="{{ url('/insert') }}" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea type="textarea" id="address" class="form-control" name="address"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" id="contact" class="form-control" maxlength name="contact">
                                    </div>
                                </div>                                                            
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" id="select" name="education">
                                          <option value="SSC">-- Selecte Education Detail</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                         <input type="text" id="company" class="form-control" name="we_company">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="designation" class="col-md-4 col-form-label text-md-right"> Designation </label>
                                    <div class="col-md-6">
                                         <input type="text" id="designation" class="form-control" name="we_designation">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                         <div class="row">
                                             <input type="date" id="date_from" class="col-md-6 form-control" name="we_date_from">
                                             <input type="date" id="date_to" class="col-md-6 form-control" name="we_date_to">
                                         </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="preference_location" class="form-control" name="preference_location">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="expected_ctc" class="col-md-4 col-form-label text-md-right">Expected CTC</label>
                                    <div class="col-md-6">
                                        <input type="text" id="expected_ctc" class="form-control" name="expected_ctc">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="current_ctc" class="col-md-4 col-form-label text-md-right">Current CTC</label>
                                    <div class="col-md-6">
                                        <input type="text" id="current_ctc" class="form-control" name="current_ctc">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="notice_period" class="col-md-4 col-form-label text-md-right">Notice Period</label>
                                    <div class="col-md-6">
                                        <input type="text" id="notice_period" class="form-control" name="notice_period">
                                    </div>
                                </div>
